...
import com.codesourav.HotelBooker.service.AwsS3Service;
...
public class RoomService implements IRoomService {
    ...
    public Response deleteRoom(Long roomId) {
        ...
        try{
            ...
            response.setStatusCode(500);
            response.setMessage("Error while deleting the room "+ e.getMessage());
        }
        return response;
    }
    ...
    public Response getRoomById(Long roomId) {
        ...
        try{
            ...
            response.setStatusCode(500);
            response.setMessage("Error while getting the room "+ e.getMessage());
        }
        return response;
    }
    ...
    public Response getAvailableRooms() {
        ...
        try{
            ...
            response.setStatusCode(500);
            response.setMessage("Error while getting the available room "+ e.getMessage());
        }
        return response;
    }
}
